package Appium_assignment;
	...
	// Write an Appium Program to connect with real device with ecommerce based application using Generalstore.app to perform locators like name, dropdown etc.
